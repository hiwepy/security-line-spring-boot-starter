 ...
 * @since 1.0.0
 */
@DisplayName("SecurityLineAutoConfiguration Tests")
class SecurityLineAutoConfigurationTest {
    ...
    void testInstantiation() {
        SecurityLineAutoConfiguration configuration = new SecurityLineAutoConfiguration();

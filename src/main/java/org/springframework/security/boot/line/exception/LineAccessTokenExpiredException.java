...
public class LineAccessTokenExpiredException extends AuthenticationTokenExpiredException {
	...
	/**
	 * Constructs an <code>LineAccessTokenExpiredException</code> with the
	 * specified message.
	 *
	 * @param msg the detail message
	 */
	public LineAccessTokenExpiredException(String msg) {
		super(msg);
	}
	 ...
	 * @param t root cause
	 */
	public LineAccessTokenExpiredException(String msg, Throwable t) {
		super(msg, t);
	}
